    ...
    public class Ensambladora
    {
        ...
        public Carro EnsamblarCarro(TipoCarro tipoCarro, TipoAuto tipoAuto, TipoBus tipoBus)
        {
            ...
            if (tipoCarro == TipoCarro.Automovil)
                carro = new Automovil(new Volante(), new Parabrisa(), 4, 5, null, TipoCarro.Automovil, tipoAuto);
            else
                carro = new Bus(new Volante(), new Parabrisa(), 4, 10, null, TipoCarro.Bus, tipoBus);
